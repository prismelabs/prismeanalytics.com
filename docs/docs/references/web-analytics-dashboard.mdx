...
import TopOutboundLinks from "./images/general-dashboard/top-outbound-links.png"
import TopFileDownloads from "./images/general-dashboard/top-file-downloads.png"
...
Other section shows your other miscellaneous data/events.

### Top outbound links

This bar gauge panels show the 10 most popular
[outbound links](./glossary.md#outbound-link).

<img src={TopOutboundLinks} height="600" alt="top outbound links bar gauge screenshot" />

### Top file downloads

This bar gauge panels show the 10 most downloaded files.

<img src={TopFileDownloads} height="600" alt="top file downloads bar gauge screenshot" />
